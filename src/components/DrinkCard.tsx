...
export default function DrinkCard({ drink }: DrinkCardProps) {
  ...
  return (
    <div
      className="bg-zinc-900 rounded-2xl border border-zinc-800 shadow-[0_4px_20px_rgba(0,0,0,0.3)] hover:shadow-fuchsia-500/20 hover:border-fuchsia-500/60 transition-all duration-300 overflow-hidden cursor-pointer"
      onClick={() => {
        selectRecipe(id);
      }}
    >
